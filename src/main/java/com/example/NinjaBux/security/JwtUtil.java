...
public class JwtUtil {
    ...
    public String generateNinjaToken(Long ninjaId, String username) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("type", "NINJA");
        claims.put("ninjaId", ninjaId);
    ...
    public Long extractNinjaId(String token) {
        return extractClaim(token, claims -> claims.get("ninjaId", Long.class));
    }
